...
public class JasperSmokeTest {
    ...
    public void jasperTestPdf() throws Exception {
        ...
        ReportFormatter formatter = new DefaultFormatterFactory().createFormatter(new FormatterFactoryInput("jasper", root,
                new ReportTemplateImpl("", "test.jasper", "./modules/core/test/smoketest/test.jasper", ReportOutputType.pdf), outputStream, false));
    ...
    public void jasperTestCsv() throws Exception {
        ...
        ReportFormatter formatter = new DefaultFormatterFactory().createFormatter(new FormatterFactoryInput("jasper", root,
                new ReportTemplateImpl("", "test.jasper", "./modules/core/test/smoketest/test.jasper", ReportOutputType.csv), outputStream, false));
        formatter.renderDocument();
    ...
    public void jasperTestDoc() throws Exception {
        ...
        ReportFormatter formatter = new DefaultFormatterFactory().createFormatter(new FormatterFactoryInput("jasper", root,
                new ReportTemplateImpl("", "test.jasper", "./modules/core/test/smoketest/test.jasper", ReportOutputType.doc), outputStream, false));
        formatter.renderDocument();
    ...
    public void jasperTestXls() throws Exception {
        ...
        ReportFormatter formatter = new DefaultFormatterFactory().createFormatter(new FormatterFactoryInput("jasper", root,
                new ReportTemplateImpl("", "test.jasper", "./modules/core/test/smoketest/test.jasper", ReportOutputType.xls), outputStream, false));
        formatter.renderDocument();
    ...
    public void jrxmlTestHtml() throws Exception {
        ...
        ReportFormatter formatter = new DefaultFormatterFactory().createFormatter(new FormatterFactoryInput("jrxml", root,
                new ReportTemplateImpl("", "test.jrxml", "./modules/core/test/smoketest/test.jrxml", ReportOutputType.html), outputStream, false));
        formatter.renderDocument();
    ...
    public void jrxmlTestXlsx() throws Exception {
        ...
        ReportFormatter formatter = new DefaultFormatterFactory().createFormatter(new FormatterFactoryInput("jrxml", root,
                new ReportTemplateImpl("", "test.jrxml", "./modules/core/test/smoketest/test.jrxml", ReportOutputType.xlsx), outputStream, false));
        formatter.renderDocument();
    ...
    public void jrxmlTestDocx() throws Exception {
        ...
        ReportFormatter formatter = new DefaultFormatterFactory().createFormatter(new FormatterFactoryInput("jrxml", root,
                new ReportTemplateImpl("", "test.jrxml", "./modules/core/test/smoketest/test.jrxml", ReportOutputType.docx), outputStream, false));
        formatter.renderDocument();
