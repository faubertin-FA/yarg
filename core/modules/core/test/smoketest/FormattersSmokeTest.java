...
public class FormattersSmokeTest extends AbstractFormatSpecificTest {
    ...
    public void testXlsxToHtml() throws Exception {
        ...
        defaultFormatterFactory.setOfficeIntegration(new OfficeIntegration(openOfficePath, 8100));
        ReportFormatter formatter = defaultFormatterFactory.createFormatter(new FormatterFactoryInput("xlsx", root,
                new ReportTemplateImpl("", "./modules/core/test/smoketest/test.xlsx", "./modules/core/test/smoketest/test.xlsx", ReportOutputType.html), outputStream, false));
        formatter.renderDocument();
    ...
    public void testCsv() throws Exception {
        ...
        ReportFormatter formatter = new DefaultFormatterFactory().createFormatter(new FormatterFactoryInput("csv", root,
                new ReportTemplateImpl("", "test.csv", "./modules/core/test/smoketest/test.csv", ReportOutputType.csv), outputStream, false));
        formatter.renderDocument();
    ...
    public void testXlsxToCsv() throws Exception {
        ...
        ReportFormatter formatter = new DefaultFormatterFactory().createFormatter(new FormatterFactoryInput("xlsx", root,
                new ReportTemplateImpl("", "./modules/core/test/smoketest/test.xlsx", "./modules/core/test/smoketest/test.xlsx", ReportOutputType.csv), outputStream, false));
        formatter.renderDocument();
