...
public class XlsxSpecificTest extends AbstractFormatSpecificTest {
    ...
    public void testXlsxRowBreaks() throws Exception {
        ...
        DefaultFormatterFactory defaultFormatterFactory = new DefaultFormatterFactory();
        ReportFormatter formatter = defaultFormatterFactory.createFormatter(new FormatterFactoryInput("xlsx", root,
                new ReportTemplateImpl("", "./modules/core/test/smoketest/row_breaks.xlsx", "./modules/core/test/smoketest/row_breaks.xlsx", ReportOutputType.xlsx), outputStream, false));
        formatter.renderDocument();
    ...
    public void testXlsxStyles() throws Exception {
        ...
        DefaultFormatterFactory defaultFormatterFactory = new DefaultFormatterFactory();
        ReportFormatter formatter = defaultFormatterFactory.createFormatter(new FormatterFactoryInput("xlsx", root,
                new ReportTemplateImpl("", "./modules/core/test/smoketest/xslx_styles.xlsx", "./modules/core/test/smoketest/xslx_styles.xlsx", ReportOutputType.xlsx), outputStream, false));
        formatter.renderDocument();
    ...
    public void testXlsxHeader() throws Exception {
        ...
        DefaultFormatterFactory defaultFormatterFactory = new DefaultFormatterFactory();
        ReportFormatter formatter = defaultFormatterFactory.createFormatter(new FormatterFactoryInput("xlsx", root,
                new ReportTemplateImpl("", "./modules/core/test/smoketest/xslx_header.xlsx", "./modules/core/test/smoketest/xslx_header.xlsx", ReportOutputType.xlsx), outputStream, false));
        formatter.renderDocument();
